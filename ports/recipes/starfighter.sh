...
em++ -O2 src/*.o -o "$OUT/index.html" $QV_LINK -sUSE_SDL=2 -sUSE_SDL_IMAGE=2 -sSDL2_IMAGE_FORMATS='["png","jpg"]' -sUSE_SDL_MIXER=2 -sSDL2_MIXER_FORMATS='["ogg","mod"]' -sASYNCIFY -sINITIAL_HEAP=32mb --preload-file gfx/ --preload-file music/ --preload-file sound/ --preload-file data/
